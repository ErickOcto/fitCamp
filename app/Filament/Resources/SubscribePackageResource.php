    ...
    public static function form(Form $form): Form
    {
        return $form
            ->schema([
                ...
                Forms\Components\TextInput::make('duration')->required()->prefix("Days")->numeric(),

                Forms\Components\Repeater::make('subscribeBenefits')->relationship('subscribeBenefits')->schema([
