        ...
        return $form
            ->schema([
                Fieldset::make('Details')->schema([
                    ...
                    Forms\Components\Repeater::make('gymPhotos')->relationship('gymPhotos')->schema([
                ...
                Fieldset::make('Additional')->schema([
                    ...
                    Forms\Components\Repeater::make('gymFacilities')->relationship('gymFacilities')->schema([
                    ...
                    Forms\Components\TimePicker::make('open_time_at')->required(),

                    Forms\Components\TimePicker::make('close_time_at')->required(),
                ]),
            ]);
    }
    ...
    public static function table(Table $table): Table
    {
        return $table
            ->columns([
                ...
                Tables\Columns\IconColumn::make('is_popular')->boolean()->trueColor('success')->falseColor('danger')->trueIcon('heroicon-o-check-circle')->falseIcon('heroicon-o-x-circle')->label('Popular'),
            ])
            ->filters([
                SelectFilter::make('city_id')->label('city')->relationship('city', 'name'),
            ])
            ->actions([
